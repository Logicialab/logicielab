		...
		<div class="container">
			...
			<ul class="nav align-items-center dropdown-hover ms-sm-2">
				...
				<li class="nav-item me-2 d-none d-sm-block">
					<a href="/contact" style="background-color: #07b850 ; color:#ffffff" class="btn btn-sm btn-light mb-0">اتخذ خطوة</a>
				</li>
	...
	<div class="container position-relative mt-5">
		<div class="row g-4 justify-content-between">
			...
			<div class="col-lg-3">
				...
				<p class="mt-4 mb-2"> لوجيسيل لاب هي شريكك الموثوق لتحقيق نجاحك في العالم الرقمي، مرحبا بك لدى شريكك المثالي لتكبير وإنجاح مشروعك.				</p>
			</div>
			<!-- Widget 1 END -->
				...
				<div class="row g-4">
					...
					<div class="col-6 col-md-4">
						...
						<ul class="nav flex-column">
							...
							{{-- <a class="nav-link" href="/ourteam">فريقنا</a> --}}
							<a class="nav-link" href="/projects">أعمالنا</a>
					...
					<div class="col-6 col-md-4">
						...
						<ul class="nav flex-column">
							<a class="nav-link" href="/services">تطبيقات الويب</a>
							<a class="nav-link" href="/services">تطبيقات الجوال</a>
							<a class="nav-link" href="/services">تطبيقات سطح المكتب</a>
							<a class="nav-link" href="/services">العلامة التجارية</a>
							<a class="nav-link" href="/services">خدمات الاستضافة</a>
						</ul>
					</div>
					...
					<div class="col-md-4">
						...
						<!-- Social buttons -->
						<h6 class="mb-2 mb-md-4">تابعنا على</h6>
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
			<!-- copyright text -->
			<div class="text-body m-auto"><p class="text-white font-weight-bold"> © 2024 جميع الحقوق محفوظة لشركة لوجيسيل لاب</p>
			</div>
			<!-- copyright links-->
			<!-- Language selector -->
