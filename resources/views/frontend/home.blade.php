		...
		<div class="row g-xl-5">
			...
			<div class="col-xl-7 mb-5 mb-xl-0">
				<div class="pe-xxl-4">
					...
					<!-- Title -->
					<h2 class="mt-3 lh-base">مرحبا بك لدى شريكك المثالي
					...
					<div class="row mt-5">
						<div class="col-md-6 mb-5 mb-md-0">
							...
							<div class="d-flex align-items-center">
								...
								<div class="ms-3">
									<h6 class="mb-1">24/7 دعم</h6>
									<p class="mb-0">نحن دائما هنا للمساعدة</p>
								</div>
							</div>
						</div>
			...
			<div class="col-md-10 d-flex col-xl-5 position-relative mx-auto mt-7 mt-xl-0">
				...
				<!-- Hero image -->
				<img src="assets/images/elements/hero-finance.svg" class="rounded" alt="hero-img">
