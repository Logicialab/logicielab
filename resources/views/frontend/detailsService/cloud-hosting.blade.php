	...
	<section class="bg-dark pt-sm-8 pb-9" data-bs-theme="dark">
		<div class="container pt-4 pt-sm-0">
			...
			<div class="row g-4 g-xxl-5">
				<!-- Hero content START -->
				<div class="col-lg-8">
					<h1 class="mb-4">خدمات الاستضافة السحابية</h1>
					<p class="mb-4 mt-4">اختر افضل استضافة سحابية لموقعك مع لوجيسيل لاب لتجربة فريدة ومتطورة تلبي احتياجاتك الشخصية والتجارية. نحن نقدم لك أفضل تجربة استضافة سحابية مع خدمات متميزة تمنحك الأمان والأداء الذي تحتاجه. </p>
				...
				<div class="col-lg-4 col-xl-3 ms-auto position-relative">
					...
					<ul class="list-group list-group-borderless mb-4">
						<li class="list-group-item d-flex heading-color pb-0"><i class="bi bi-patch-check text-primary me-2"></i>أمان عالي						</li>
						<li class="list-group-item d-flex heading-color pb-0"><i class="bi bi-patch-check text-primary me-2"></i>مرنة وقابلة للتوسع						</li>
						<li class="list-group-item d-flex heading-color pb-0"><i class="bi bi-patch-check text-primary me-2"></i>أداء استثنائي						</li>
						<li class="list-group-item d-flex heading-color pb-0"><i class="bi bi-patch-check text-primary me-2"></i>دعم متميز</li>
					</ul>
				</div>
			</div>
			<!-- Hero END -->
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="card card-body bg-primary p-5 pt-8 overflow-hidden">
						...
						<!-- Content -->
						<h5 class="text-white fw-light">اختر افضل استضافة سحابية لموقعك مع لوجيسيل لاب لتجربة فريدة ومتطورة تلبي احتياجاتك الشخصية والتجارية. نحن نقدم لك أفضل تجربة استضافة سحابية مع خدمات متميزة تمنحك الأمان والأداء الذي تحتاجه.						</h5>
				...
				<div class="col-lg-8 position-relative ms-auto ps-xl-6 mt-6">
					...
					<div class="card card-body overflow-hidden p-0">
						<img src="assets/images/about/13.jpg" class="card-img" alt="video-img">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-8 mb-5 mb-lg-0">
					<!-- Title -->
					<h2 class="mb-3 mb-lg-5">مزايا الاستضافة السحابية من لوجيسيل لاب</h2>
	
					<!-- Steps -->
					<div class="d-flex align-items-center gap-3 mb-2">
						<i class="bi bi-patch-check text-primary me-2"></i>
						<h6 class="mb-0" style="font-weight: 300">نحن نفهم أهمية أمان بياناتك. من خلال تشفير قوي وإجراأت أمان متقدمة، نضمن سلامة بياناتك، في حالة حدوث أي مشكلة، يمكن الانتقال بسهولة إلى النسخ البديلة.						</h6>
					</div>
	
					<!-- Steps -->
					<div class="d-flex align-items-center gap-3 mb-3">
						<i class="bi bi-patch-check text-primary me-2"></i>
						<h6 class="mb-0" style="font-weight: 300">تتيح لك استضافتنا السحابية توسيع مواردك وتقليلها بسهولة وفقًا لاحتياجات مشروعك.</h6>
					</div>
	
					<!-- Steps -->
					<div class="d-flex align-items-center gap-3 mb-3">
						<i class="bi bi-patch-check text-primary me-2"></i>
						<h6 class="mb-0" style="font-weight: 300">تقدم خوادمنا على السحابة أداءً فائقًا بفضل الامتيازات التي نقدمها. سوف تستمتع بسرعات عالية وزمن استجابة قصير.</h6>
					</div>
	
					<!-- Steps -->
					<div class="d-flex align-items-center gap-3 mb-3">
						<i class="bi bi-patch-check text-primary me-2"></i>
						<h6 class="mb-0" style="font-weight: 300">فريق دعم لوجيسيل لاب دائمًا متاح لمساعدتك في حل أي مشكلة أو استفسار. نحن هنا لضمان رضاك.</h6>
					</div>

						<!-- Steps -->
						<div class="d-flex align-items-center gap-3">
							<i class="bi bi-patch-check text-primary me-2"></i>
							<h6 class="mb-0" style="font-weight: 300">يتيح لك نموذج الاستضافة السحابية القليل من المواقع على السيرفر، وبالتالي تجنب التكدس. هذا يؤدي إلى زيادة سرعة موقعك بشكل ملحوظ وتقديم تجربة متميزة للمستخدمين.</h6>
						</div>
	...
	<section class="pt-0">
		<div class="container">
			<div class="inner-container-small text-center mb-4 mb-md-6">
				<h2 class="mb-0">انواع خدمات الاستضافة المقدمة من شركة لوجيسيل لاب</h2>
			</div>
	
			<div class="row g-4 g-lg-7">
				<div class="col-sm-6 col-md-3">
					<div class="d-flex justify-content-center align-items-center text-center flex-column bg-transparent">
						<div class="icon-lg bg-primary bg-opacity-10 text-primary rounded-3 fw-bold flex-shrink-0 mb-3">01</div>
						<h6>الاستضافة السحابية العامة</h6>
						<p class="small mb-0">في هذا النوع، يتم مشاركة موارد السحابة بين مستخدمين متعددين. يعني ذلك أنك تدفع فقط مقابل الموارد التي تستخدمها. هذا النوع من الاستضافة مناسب للمشاريع الصغيرة والمتوسطة والتي تحتاج إلى مرونة واقتصاد.</p>
					</div>
				</div>
	
				<div class="col-sm-6 col-md-3">
					<div class="d-flex justify-content-center align-items-center text-center flex-column bg-transparent">
						<div class="icon-lg bg-primary bg-opacity-10 text-primary rounded-3 fw-bold flex-shrink-0 mb-3">02</div>
						<h6>الاستضافة السحابية الخاصة</h6>
						<p class="small mb-0">في هذا النوع، يتم مشاركة موارد السحابة بين مستخدمين متعددين. يعني ذلك أنك تدفع فقط مقابل الموارد التي تستخدمها. هذا النوع من الاستضافة مناسب للمشاريع الصغيرة والمتوسطة والتي تحتاج إلى مرونة واقتصاد.</p>
					</div>
				</div>
				...
				<div class="col-sm-6 col-md-3">
					<div class="d-flex justify-content-center align-items-center text-center flex-column bg-transparent">
						<div class="icon-lg bg-primary bg-opacity-10 text-primary rounded-3 fw-bold flex-shrink-0 mb-3">03</div>
						<h6>الاستضافة السحابية للتطبيقات</h6>
						<p class="small mb-0">تتيح هذه الخدمة استضافة التطبيقات والبرمجيات في السحابة. يمكن للمطورين نشر تطبيقاتهم وتحديثها بسرعة وسهولة.</p>
					</div>
				</div>
	
				<div class="col-sm-6 col-md-3">
					<div class="d-flex justify-content-center align-items-center text-center flex-column bg-transparent">
						<div class="icon-lg bg-primary bg-opacity-10 text-primary rounded-3 fw-bold flex-shrink-0 mb-3">04</div>
						<h6>الاستضافة السحابية للمواقع</h6>
						<p class="small mb-0">تعتبر هذه الخدمة مناسبة لاستضافة مواقع الويب. تتيح لك الوصول السريع والاستفادة من ميزات مشتركة مثل الدومينات وقواعد البيانات.</p>
					</div>
				</div>
			</div>

            <div class="row g-4 g-lg-7 m-auto d-flex justify-content-center">
				<div class="col-sm-6 col-md-3">
					<div class="d-flex justify-content-center align-items-center text-center flex-column bg-transparent">
						<div class="icon-lg bg-primary bg-opacity-10 text-primary rounded-3 fw-bold flex-shrink-0 mb-3">05</div>
						<h6>الاستضافة السحابية للتخزين</h6>
						<p class="small mb-0">تتيح لك هذه الخدمة تخزين الملفات والبيانات على السحابة. يمكن الوصول إلى الملفات من أي مكان وفي أي وقت.</p>
					</div>
				</div>
	
				<div class="col-sm-6 col-md-3">
					<div class="d-flex justify-content-center align-items-center text-center flex-column bg-transparent">
						<div class="icon-lg bg-primary bg-opacity-10 text-primary rounded-3 fw-bold flex-shrink-0 mb-3">06</div>
						<h6>الاستضافة السحابية للألعاب</h6>
						<p class="small mb-0">تُستخدم لاستضافة ألعاب الفيديو عبر الإنترنت. توفر موارد سحابية عالية الأداء للاعبين وتتيح لهم اللعب بسلاسة.</p>
					</div>
				</div>
