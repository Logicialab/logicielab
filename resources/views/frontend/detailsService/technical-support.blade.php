		...
		<div class="container position-relative pt-4 pt-lg-0">
			<div class="row align-items-center">
				...
				<div class="col-md-7 col-xl-6 mb-7 mb-md-0">
					<h1 class="mb-4">خدمات الدعم الفني</h1>

					<p class="mb-4">اكتشف عالم التصميم مع خدماتنا المميزة في مجالات التصميم الإبداعي. نحن نقدم خدمات التصميم التي تأخذ عملك إلى مستوى جديد من التميز والاحترافية. مع خدماتنا في التصميم، ستحصل على إبداع لا حدود له وأفكار مبتكرة تمنح علامتك التجارية مكانة استثنائية في السوق. انضم إلينا اليوم لتجربة عالم التصميم بأبهى صوره.                    </p>

					<a href="/contact" class="btn btn-lg btn-dark mb-5"><i class="bi bi-telephone me-2"></i>تواصل معانا</a>
					<!-- Rating -->
				...
				<div class="col-md-5 ms-auto">
					<img src="assets/images/elements/service.svg" alt="">
				</div>
			</div>
		</div>	
	</section>
		...
		<div class="container">
			...
			<div class="row g-4 align-items-center">
				...
				<div class="col-lg-6 ps-md-5">
					<h2 class="mb-4">أهمية تصميم تطبيقات الجوال لنشاطك التجاري</h2>

					<p class="mb-0">في لوجيسيل لاب نحن ملتزمون بتقديم تجربة تصميم تطبيقات استثنائية تلبي احتياجات عملائنا بأسلوب فريد ومبتكر.</p>

	
					<hr class="my-4">
					<p>أصبحت التطبيقات الإلكترونية تدخل في كافة الأنشطة في حياتنا اليومية، وبالتالي فإنها بالتأكيد ستكون مفيدة جدًا لنشاطك التجاري وهذا للأسباب الآتية: </p>
					...
					<div class="text-center d-inline-block bg-dark rounded px-5 py-3 mt-4 mt-lg-5">
						<span class="text-white"></span> <a class="ms-2" href="/contact">تواصل معانا<span class="bi-chevron-right small ms-1"></span></a>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="pt-0">
		<div class="container">
			<div class="inner-container-small text-center mb-4 mb-md-6">
				<h2 class="mb-0">المميزات التي تحصل عليها عند تصميم تطبيق الجوال مع لوجيسيل لاب</h2>
			</div>
					...
					<div class="row g-4 g-lg-5">
						...
						<div class="col-md-6">
							<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
								...
								<div class="d-flex flex-column ms-4">
									<h6 class="mb-3">الاستضافة</h6>
									<p class="mb-3">نستخدم أحدث التقنيات لضمان أداء تطبيقات سلس وسرعة استجابة عالية و نوفر بيئة استضافة محمية بتقنيات أمان متقدمة لحماية بيانات عملائنا لأننا نؤمن ان الاختيار السليم للإستضافة من أهم عوامل نجاح الموقع أو التطبيق</p>
						...
						<div class="col-md-6">
							<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
								...
								<!-- Title -->
								<div class="d-flex flex-column ms-4">
									<h6 class="mb-3">تصميم تطبيقات الموبايل</h6>
									<p class="mb-3">نستخدم أحدث التقنيات والأدوات في تطوير التطبيقات لضمان أداء متفوق وسرعة استجابة كما نسعى لتوفير تجربة مستخدم استثنائية من خلال واجهات سهلة الاستخدام وتصميم جذاب, لتحصل في النهاية على تصميمًا فريدًا ومخصصًا يتناسب مع رؤيتك</p>
						...
						<div class="col-md-6">
							<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
								...
								<!-- Title -->
								<div class="d-flex flex-column ms-4">
									<h6 class="mb-3">خدمات الدعم الفني</h6>
									<p class="mb-3">نوفر دعمًا فنيًا متاحًا على مدار الساعة، طوال أيام الأسبوع مع فريق من المحترفين المؤهلين تقنياً للرد على استفساراتك ومساعدتك في حل المشاكل بفعالية.كما نقوم بمتابعة حالة مشاكلك وتقديم تحسينات دورية لضمان تقديم أفضل خدمة</p>
						...
						<div class="col-md-6">
							<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
								...
								<!-- Title -->
								<div class="d-flex flex-column ms-4">
									<h6 class="mb-3">تطوير تطبيقات الجوال</h6>
									<p class="mb-3">تطوير تطبيقات الجوال هو مجال تقني متطور يشمل العدat best fit each project and its unique requirementsيد من التقنيات والأدوات.  لذلك نحرص دوما في لوجيسيل لاب أن نواكبً التطورات في مجال تطوير تطبيقات الجوال حيث تظهر تقنيات جديدة بشكل مستمر، وأن نختار الأدوات والتقنيات التي تناسب كل مشروع.</p>
						...
						<div class="col-md-6">
							<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
								...
								<!-- Title -->
								<div class="d-flex flex-column ms-4">
									<h6 class="mb-3">خدمة الدفع الإلكتروني</h6>
									<p class="mb-3">خدمة الدفع الإلكتروني تلعب دورًا حاسمًا في تطوير تطبيقات الجوال، سواء كان ذلك للتجارة الإلكترونية أو لأي نوع آخر من التطبيقات التي تتطلب معالجة المدفوعات لذلك نقوم ب استخدام كل الخدمات الدفع المتوفرة بما يتوافق مع احتياج العملاء.</p>
						...
						<div class="col-md-6">
							<div class="card card-body card-hover-shadow border d-flex flex-row p-4 h-100">
								...
								<div class="d-flex flex-column ms-4">
									...
									<h6 class="mb-3">كتابة محتوى مناسب</h6>
									<p class="mb-3">نحرص على كتابة محتوى يتناسب مع أحجام الشاشات المختلفة والأجهزة اللوحية ويجذب انتباه الفئة التي تستهدفها المحتوي هو عنصر مهم في تطوير تطبيقات الجوال لضمان تجربة المستخدم الجيده على مختلف الأجهزة</p>
