<div class="col-lg-6 col-xl-5">
    ...
    <div class="card card-body shadow border p-sm-5">
        ...
        <figure class="position-absolute top-100 start-0 translate-middle mt-n5">
            <svg width="225.3px" height="168.1px" viewBox="0 0 225.3 168.1"
                style="enable-background:new 0 0 225.3 168.1;" xml:space="preserve">
        ...
        <form class="row g-4" action="{{ route('store.contact') }}" method="POST">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="email" name="email" class="form-control form-control-lg" id="floatingInput"
                    placeholder="بريدك الالكتروني ">
            </div>

            <div class="col-md-6">
                <label class="form-label heading-color"> رقم الهاتف *</label>
                <input type="text" name=phone class="form-control form-control-lg" placeholder="(xxx) xx xxxx">
            </div>

            <div class="col-md-6">
                <label class="form-label heading-color"> الموضوع *</label>
                <input type="text" name="subject" class="form-control form-control-lg" placeholder=" الموضوع  ">
            </div>

            <div class="col-12">
                <label class="form-label heading-color"> رسالتك *</label>
                <textarea class="form-control" name="description" placeholder=" أدخل رسالتك هنا " id="floatingTextarea2"
                    style="height: 150px"></textarea>
            </div>
            <!-- Button -->
            <button type="submit" class="btn btn-lg btn-primary mb-0">إرسال الطلب</button>
        </form>
    </div>
</div>
