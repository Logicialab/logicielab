        ...
        <div class="container">
            ...
            <div class="row align-items-center g-4 mb-4 mb-sm-5">
                <div class="col-md-6 col-lg-5">
                    <h2 class="mb-0">أحدث مشاريعنا</h2>
                </div>
                <div class="col-md-6 col-lg-4 ms-auto text-md-end">
                    <a href="/projects" class="btn btn-lg btn-dark mb-0">عرض جميع المشاريع</a>
                </div>
            </div>
            ...
            <div class="row g-4 g-md-5">
                <div class="col-lg-6">
                    <div class="card bg-light p-3 p-sm-4 card-img-scale overflow-hidden">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-center px-0 pb-0">
                            <div class="me-3">
                                <h5 class="mb-0"><a href="/projects" class="heading-color stretched-link">Website optimization for techWave</a></h5>
                ...
                <div class="col-lg-6">
                    <div class="card bg-light p-3 p-sm-4 card-img-scale overflow-hidden">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-center px-0 pb-0">
                            <div class="me-3">
                                <h5 class="mb-0"><a href="/projects" class="heading-color stretched-link">Transforming ideas into reality</a></h5>
